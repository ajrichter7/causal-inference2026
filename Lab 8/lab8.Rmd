...
comparison_adjusted <- data.frame(
  estimate = c("Adjusted OLS", "Adjusted IV"),
  value = c(
...
**Whole class (5 minutes).** Do the results look more convincing for `infopro` than for `support`? Why might media exposure affect feeling informed more directly than vote choice or policy support?
